...
<div class="row">
    <div class="col-sm-9">
                ...
                <div class="thread-info">
                    ...
                    <div class="pull-right">
                        ...
                        <?php if ($user['id'] == Yii::$app->user->id || $board['user_id'] == Yii::$app->user->id): ?>
                            <a href="<?= Url::toRoute(['/pre-forum-thread/update', 'id' => $model['id']]) ?>">
                                <span class="glyphicon glyphicon-pencil"></span> <?= Yii::t('app', 'Update') ?>
                            </a>
                            &nbsp;
                            <a href="<?= Url::toRoute(['/pre-forum-thread/delete', 'id' => $model['id']]) ?>"  data-confirm="<?= Yii::t('app', 'Are you sure to delete it?') ?>" data-method="post">
        ...
        <!-- Post Form Begin -->
        <?= $this->render('/pre-forum-post/_form',[
                'model'=>$newPost,
            ]);
        ?>
        <!-- Post Form End -->
