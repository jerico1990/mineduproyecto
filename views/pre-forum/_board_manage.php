...
<?php foreach($model->boards as $board): ?>
    ...
    <div class="tbox boarder">
        <div class="<?= ($board->parent_id == PreForumBoard::AS_CATEGORY) ? 'category' : 'board' ; ?>" style="boarder-bottom:none;">
            <h2>
                <?php if ($board->parent_id == PreForumBoard::AS_BOARD): ?>
...
<div class="new-category tbox">
    <?php Modal::begin([
        ...
        <?php $form = ActiveForm::begin(); ?>
            ...
            <?= $form->field($newBoard, 'parent_id')->textInput(['readonly' => true, 'value' => PreForumBoard::AS_CATEGORY, 'style' => 'display:none'])->label(false) ?>
    ...
    <?php Modal::begin([
        ...
        <?php $form = ActiveForm::begin(); ?>
            ...
            <?= $form->field($newBoard, 'parent_id')->textInput(['readonly' => true, 'value' => PreForumBoard::AS_BOARD, 'style' => 'display:none'])->label(false) ?>
